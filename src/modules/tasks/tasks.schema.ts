...
/** Dữ liệu thô từ client (trước khi zod áp default). */
export type CreateTaskInput = z.input<typeof createTaskSchema>;
export type SwapSprintTaskInput = z.input<typeof swapSprintTaskSchema>;

/** Dữ liệu đã validate, truyền vào service. */
export type CreateTaskData = z.output<typeof createTaskSchema>;
export type UpdateTaskStatusData = z.output<typeof updateTaskStatusSchema>;
export type SwapSprintTaskData = z.output<typeof swapSprintTaskSchema>;
