...
export type CreateTicketPayload = z.input<typeof createTicketSchema>;
/** Dữ liệu đã validate, dùng cho tầng service. */
export type CreateTicketInput = z.output<typeof createTicketSchema>;

export type UpdateTicketStatusInput = z.output<typeof updateTicketStatusSchema>;
